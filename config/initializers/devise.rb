...
Devise.setup do |config|
  ...
  # config.secret_key =
  #   'f4eb6b276ba2c8a704e9be1985ed9c74b1129a38d784875e350e0e657f23f7932245efa'\
  #   '0bb6ab41e6ba34426b00912c151dc74508f003b951d6f036ac236e36f'
  ...
  config.mailer_sender = 'Card Baseball <noreply@task-roller.net>'
  ...
  # will enable it only for database authentication. For API-only applications
  # to support authentication "out-of-the-box", you will likely want to enable
  # this with :database unless you are using a custom strategy.
  ...
  # config.pepper =
  #   '9e5edcba4bd5ff307393f7740fcb500c23bee22e651fc055b3b09dc8d4fe33a33989db4'\
  #   'd1ba4a9d45e8d644c7d56c7f251a489008da85f4568748223a4b3ae30'
